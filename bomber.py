...
# Developed by Byelordy
# For private testing only, I take no responsibility
# for your illegal acts.

# 13/12/2022 -  U‘RE WELCOME HONEY
...
parser = CustomArgumentParser(
    allow_abbrev=False,
    add_help=False,
    description="Cortex SMS Bomber script, FULL PYTHON.",
...
# GitHub:  https://github.com/byelordy   <--- FOLLOW ME RN BRO
